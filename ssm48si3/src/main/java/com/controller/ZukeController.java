...
public class ZukeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZukeEntity user = zukeService.selectOne(new EntityWrapper<ZukeEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody ZukeEntity zuke){
    	...
    	ZukeEntity user = zukeService.selectOne(new EntityWrapper<ZukeEntity>().eq("yonghuming", zuke.getYonghuming()));
		if(user!=null) {
